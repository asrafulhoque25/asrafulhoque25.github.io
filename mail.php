...
if ($name == "") {
    ...
    $headers .= 'From:  Papr <asrafulhoque.dev@gmail.com>' . "\r\n";
    $headers .= 'cc: asrafulhoque.dev@gmail.com' . "\r\n";
    $headers .= 'bcc: asrafulhoque.dev@gmail.com' . "\r\n";
    mail($to, $subject, $_message, $headers, '-f asrafulhoque.dev@gmail.com');
